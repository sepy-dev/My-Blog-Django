...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('blog', '0011_alter_article_author_alter_article_pb_timezone_and_more'),
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='article',
            name='Pb_Timezone',
            field=models.DateField(default=datetime.datetime(2025, 4, 30, 15, 29, 40, 544312, tzinfo=datetime.timezone.utc)),
        ),
